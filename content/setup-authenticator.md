...
Did not get the notification? Open the Authenticator app and tap your SCU account to approve it yourself.
...
On your old phone: open Authenticator, go to **Settings**, turn on **cloud backup**. On your new phone: install the app and restore.

If your old phone is gone: go to <a href="https://mysignins.microsoft.com/security-info">mysignins.microsoft.com/security-info</a> on a computer, delete the old entry, and start fresh.